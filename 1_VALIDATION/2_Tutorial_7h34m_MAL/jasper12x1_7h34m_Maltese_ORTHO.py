...
train_dataset = "MALTESE_train_7h34m.json"

# Path to our validation manifest
eval_datasets = "MALTESE_test_31m.json"
...
yaml = YAML(typ="safe")
with open("jasper12x1SEP.yaml") as f:
...
data_layer = nemo_asr.AudioToTextDataLayer(
    ...
    labels=labels, batch_size=16, shuffle=False, normalize_transcripts=False)
