...
data_layer = nemo_asr.AudioToTextDataLayer(
    ...
    labels=labels, batch_size=24, shuffle=True, normalize_transcripts=False)
data_layer_val = nemo_asr.AudioToTextDataLayer(
    manifest_filepath=eval_datasets,
    labels=labels, batch_size=24, shuffle=False, normalize_transcripts=False)
