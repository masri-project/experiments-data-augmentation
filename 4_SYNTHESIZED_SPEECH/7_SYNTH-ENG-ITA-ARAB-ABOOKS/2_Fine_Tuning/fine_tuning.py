...
train_dataset = "TRAIN_MASRI_HEADSET_V2.json"

# Path to our validation manifest
eval_datasets = "TEST_MASRI_HEADSET_V2.json"
...
yaml = YAML(typ="safe")
with open("jasper_an4_NEW_ORTHO.yaml") as f:
...
data_layer = nemo_asr.AudioToTextDataLayer(
    ...
    labels=labels, batch_size=32, shuffle=True, normalize_transcripts=False)
data_layer_val = nemo_asr.AudioToTextDataLayer(
    manifest_filepath=eval_datasets,
    labels=labels, batch_size=32, shuffle=False, normalize_transcripts=False)

data_preprocessor = nemo_asr.AudioToMelSpectrogramPreprocessor()
spec_augment = nemo_asr.SpectrogramAugmentation(rect_masks=5, rect_time=2, rect_freq=2)
...
jasper_encoder.restore_from("/home/carlos/DATOS/VARIOS_PROGRAMAS/SYNC_EXPES/ALL_TOGETHER/1_Gross_Training/CHECKPOINTS/JasperEncoder-STEP-350500.pt")
...
jasper_decoder.restore_from("/home/carlos/DATOS/VARIOS_PROGRAMAS/SYNC_EXPES/ALL_TOGETHER/1_Gross_Training/CHECKPOINTS/JasperDecoderForCTC-STEP-350500.pt")
...
eval_callback = nemo.core.EvaluatorCallback(
    ...
    user_epochs_done_callback=partial(
        process_evaluation_epoch, tag="TEST", logger=logger
        ),
    eval_step=500,
    tb_writer=tb_writer)
