...
train_dataset = "ITALIAN_CORPUS_118h41m.json,0100h_TRAIN.json,MALTES-ARABE_100h.json,AUDIOBOOKS_1C.json,MASRI_SYNTHETIC_CLEAN.json"
#train_dataset = 'JSON_MALTESE_ORDENADO.json'
...
spec_augment = nemo_asr.SpectrogramAugmentation(rect_masks=5, rect_time=120, rect_freq=50)
